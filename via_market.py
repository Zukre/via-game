...
# ЛИКВИДНОСТЬ СТАКАНА в $ по типу (Ринат 11июл): у ВСЕХ крупных активов — ОГРОМНЫЕ стаканы,
# любые нормальные объёмы поглощаются спокойно, цену двинут только МИЛЛИОНЫ. Тонкий стакан —
# ТОЛЬКО у мемкоинов (Zen/APXM/Metaflare), которыми мало кто торгует → заявка реально двигает цену.
